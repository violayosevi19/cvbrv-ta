...
<head>
    <meta charset="utf-8">
    <title>CETAK Supplier CVBRV</title>
...
<body class="A4">
    ...
    <div class="container">
        <h1>Daftar SUPPLIER CV BRV</h1>
        <table>
            <tr>
                <th class="small-col">No</th>
                <th class="kode-col">Kode Supplier</th>
                <th class="stok-col">Nama Supplier</th>
            ...
            <tr>
                ...
                <td class="kode-col">{{ $item->kodesupplier }}</td>
                <td class="stok-col">{{ $item->namasupplier }}</td>
                <td class="harga-col">{{ $item->nohp }}</td>
